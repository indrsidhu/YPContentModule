 ...
 */
class ContentController extends YPController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['YPContent']))
		{
			...
			if($model->save()){
				Yii::app()->user->setFlash('success','Content created successfully');
				$this->redirect(array('admin'));
			} else{
				Yii::app()->user->setFlash('error','Unable to create content');
			}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['YPContent']))
		{
			...
			if($model->save()){
				...
				Yii::app()->user->setFlash('error','Unable to update content');
			}
		}
